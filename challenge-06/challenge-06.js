...
desafio.
*/
var teams = ['Avaí FC', 'Figueirense FC', 'Chapecó FC', 'Joinville FC', 'Brusque FC'];
...
function showTeamPosition(position) {
  return (position - 1) < 5 ? 'O time que está em ' + position + 'º lugar é o ' + teams[position - 1] + '.' : 'Não temos a informação do time que está nessa posição.';
};
